...
export default function DeskIllustration({
  ...
  return (
    <svg viewBox="0 0 900 520" role="img" aria-label={`${colours.name} illustrated workspace desk`}>
      <rect x="18" y="18" width="864" height="484" rx="28" fill={colours.desk} stroke={colours.deskEdge} />
      <rect x="185" y="70" width="360" height="210" rx="20" fill={colours.monitor} stroke={colours.deskEdge} />
      <rect x="215" y="100" width="300" height="150" rx="12" fill={isNight ? "#141211" : colours.text} opacity={isNight ? ".78" : ".88"} />
      <path d="M248 134h142M248 166h210M248 198h118M248 230h174" stroke={colours.screenGlow} strokeWidth="9" strokeLinecap="round" />
      <rect x="292" y="288" width="150" height="16" rx="8" fill={colours.accent} opacity=".72" />
      <rect x="214" y="326" width="316" height="82" rx="18" fill={colours.paper} stroke={colours.deskEdge} />
      {Array.from({ length: 12 }).map((_, i) => (
        <rect key={i} x={236 + i * 22} y="348" width="14" height="12" rx="4" fill={i % 3 === 0 ? colours.note1 : i % 3 === 1 ? colours.note2 : colours.note3} />
      ))}

      {showDecorations && (
        <>
          <rect x="615" y="92" width="76" height="86" rx="18" fill={colours.mug} stroke={colours.deskEdge} />
          ...
          <rect x="650" y="325" width="92" height="88" rx="18" fill={colours.plant} stroke={colours.deskEdge} />
          <path d="M696 325c-42-54-98-28-54 10M696 325c34-68 92-32 44 8" fill={colours.leaf} />
          <rect x="640" y="410" width="116" height="26" rx="13" fill={colours.deskEdge} />
          <circle cx="775" cy="322" r="11" fill={colours.leaf} />
          <rect x="733" y="334" width="112" height="82" rx="10" fill={colours.plant} stroke={colours.deskEdge} transform="rotate(7 789 375)" />
        </>
      )}
      ...
      <rect x="86" y="114" width="116" height="86" rx="10" fill={colours.note2} stroke={colours.deskEdge} transform="rotate(-8 144 157)" />
      <rect x="148" y="126" width="112" height="82" rx="10" fill={colours.note1} stroke={colours.deskEdge} transform="rotate(-3 204 167)" />
    </svg>
  );
}
