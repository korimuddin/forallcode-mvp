    ...
    return (
      <div className="cert-page">
        <section className="cert-card">
          ...
          <p>Buy the Git Fundamentals Certificate before starting the assessment.</p>
          <Link className="button primary" to="/certification/git-fundamentals">Back to certificate page</Link>
        </section>
      </div>
    );
  }
    ...
    <div className="cert-page">
      ...
      <section className="cert-assessment">
        <header className="cert-assessment-header">
          <div>
            <p className="eyebrow">Question {index + 1} of {GIT_FUNDAMENTALS_QUESTIONS.length}</p>
            <h1>Git Fundamentals Assessment</h1>
          </div>
        ...
        <footer className="cert-assessment-actions">
          ...
          {index === GIT_FUNDAMENTALS_QUESTIONS.length - 1 ? (
